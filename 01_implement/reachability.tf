...
# resource "aws_ec2_network_insights_path" "aws_pub_n1_to_aws_pub_n3" {
#   source      = aws_instance.aws_public_node1.id
#   destination = aws_instance.aws_public_node3.id
#   protocol    = "tcp"

#   tags = {
#     Name  = "aws_pub_n1_to_aws_pub_n3"
#     Owner = "John Ajera"
#   }
# }

# resource "aws_ec2_network_insights_analysis" "aws_pub_n1_to_aws_pub_n3" {
#   network_insights_path_id = aws_ec2_network_insights_path.aws_pub_n1_to_aws_pub_n3.id
...
# resource "aws_ec2_network_insights_path" "aws_pvt_n1_to_aws_pvt_n3" {
#   source      = aws_instance.aws_private_node1.id
#   destination = aws_instance.aws_private_node3.id
#   protocol    = "tcp"

#   tags = {
#     Name  = "aws_pvt_n1_to_aws_pvt_n3"
#     Owner = "John Ajera"
#   }
# }

# resource "aws_ec2_network_insights_analysis" "aws_pvt_n1_to_aws_pvt_n3" {
#   network_insights_path_id = aws_ec2_network_insights_path.aws_pvt_n1_to_aws_pvt_n3.id
